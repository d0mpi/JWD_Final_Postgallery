                                    ...
                                    <div class="col-33">
                                        <div class="input-box">
                                            <label for="add-wingspan" class="add-label"> <fmt:message
                                                    key="postWingspan" bundle="${text}"/>(<fmt:message key="MPostfix" bundle="${text}"/>)</label>
                                    ...
                                    <div class="col-half">
                                        <div class="input-box">
                                            <label for="add-type" class="add-label"> <fmt:message
                                                    key="postType" bundle="${text}"/></label>
                                            <select id="add-type" name="type" type="text" class="input-text">
                                                <option value="default" label="Select plane type ..." selected="selected"></option>
                                    ...
                                    <div class="col-half">
                                        <div class="input-box">
                                            ...
                                            <select name="origin" class="input-text" id="add-origin">
                                                <option value="default" label="Select a country ... " selected="selected">Select a country ... </option>

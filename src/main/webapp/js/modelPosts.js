...
class PostCollection {
    ...
    #postList = [
        ...
        },
        {
            ...
            createdAt: new Date(),
            author: 'admin',
            photoLink: 'images/planes/AC-130H.jpg',
            hashtags: ["Spectre", "Lockheed_Martin",  "attack", "USA"],
            likes: []
        },
        {
            id: '13',
            ...
            createdAt: new Date(),
            author: 'admin',
            photoLink: 'images/planes/SR-71.jpg',
            hashtags: ["Lockheed_Martin", "Blackbird", "USA"],
            likes: []
        }
    ];
